...
namespace Labirint
{
    public partial class MainForm : Form
    {
        ...
        private void ShowLabirint()
        {
            ...
            int[,] map = pf.Field;//копируем карту лабиринта
            ...
            for (int i = 0; i < Length; i++)
            {
                ...
                dataGridViewLabirint.Columns[i].Width = 10;
                //устанавливаем ширину колонок
                dataGridViewLabirint.Rows[i].Height  = 10;
        ...
        private void buttonShowPath_Click(object sender, EventArgs e)
        {
            ...
            pf.SearchPath();//поиск возможных маршрутов
        ...
        {
            pf.CopyMapToField();//копируем лабиринт в поле для обработки
